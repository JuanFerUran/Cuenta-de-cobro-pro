    ...
    <div className="a4-preview flex flex-col font-sans text-slate-800 bg-white mx-auto overflow-hidden relative shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] border border-slate-200 rounded-sm">
      ...
      <div className="px-12 py-12 flex justify-between items-start">
        <div className="space-y-4">
          <div className="flex items-center gap-4">
             ...
             <div>
                ...
                <p className="text-[10px] font-black text-blue-600 mt-1 uppercase tracking-widest">{myData.documento}</p>
             </div>
          </div>
        ...
        <div className="text-right">
          <h1 className="text-2xl font-black text-slate-900 uppercase italic">Cuenta de <span className="text-blue-600">Cobro</span></h1>
          <div className="mt-4 inline-block bg-slate-950 text-white px-5 py-2 rounded-xl font-black text-xs">
      ...
      <div className="px-12 grid grid-cols-2 gap-6 mb-10">
        ...
        <div className="bg-blue-600 p-6 rounded-3xl flex flex-col justify-center items-end text-white shadow-xl shadow-blue-100">
      ...
      <div className="px-12 pb-12 mt-8">
        <div className="grid grid-cols-2 gap-12 pt-8 border-t border-slate-100">
          <div>
            <h3 className="text-[9px] font-black text-blue-600 uppercase mb-4">DATOS PARA EL PAGO</h3>
            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100 space-y-1 shadow-inner">
              ...
              <p className="text-[10px] text-slate-600 font-bold">Cuenta {bankData.tipo}: <span className="text-blue-600">{bankData.numero}</span></p>
        ...
        <div className="mt-12 text-center opacity-40">
          <p className="text-[8px] text-slate-400 leading-relaxed font-bold uppercase tracking-tight max-w-sm mx-auto">
            Este documento cumple con los requisitos del Art. 774 del código de comercio.
          </p>
          <p className="text-[10px] font-black text-blue-600 mt-2 uppercase tracking-[0.2em]">Generado por Axyra</p>
        </div>
      </div>
    </div>
  );
